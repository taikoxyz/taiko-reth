...
use reth_payload_builder::StateAttributes;
...
unsafe impl<Node, AddOns> Send for NodeTestContext<Node, AddOns>
where
    Node: FullNodeComponents,
    AddOns: NodeAddOns<Node>,
{}
    ...
    AddOns: NodeAddOns<Node>,
{
    ...
    pub async fn advance(
        ...
        attributes_generator: impl Fn(u64, Vec<TransactionSigned>, StateAttributes) -> <Node::Engine as PayloadTypes>::PayloadBuilderAttributes
            + Copy,
    ) -> eyre::Result<
        Vec<(
